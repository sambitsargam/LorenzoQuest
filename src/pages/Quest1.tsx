      ...
      <div className="flex rounded-lg p-6 m-10 shadow-md text-white font-quicksand">
        <div className="w-4/5 pr-5 border-r border-gray-500">
          ...
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            ...
            <p className="ml-3">Follow @LorenzoProtocol on X</p>
            <div className="ml-auto">
              <a href="https://twitter.com/intent/follow?screen_name=LorenzoProtocol" target="_blank" rel="noopener noreferrer">
                <button
          ...
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            ...
            <span className="ml-3">Join Lorenzo Discord Server</span>
            <div className="ml-auto">
              <a href="https://discord.com/invite/fybK7C4gMH" target="_blank" rel="noopener noreferrer">
                <button
                  className={`task-button ml-auto bg-blue-500 text-white font-semibold py-2 px-4 rounded 
                    ${
                      joinClicked
          ...
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            ...
            <span className="ml-3">Join @Lorenzo on Telegram</span>
            <div className="ml-auto">
              <a href="https://t.me/lorenzoprotocol" target="_blank" rel="noopener noreferrer">
                <button
                  className={`task-button ml-auto bg-blue-500 text-white font-semibold py-2 px-4 rounded 
                    ${
                      telegramClicked
          ...
          <div className="bg-gray-800 task-item mb-4 border-white-800 p-5 rounded-lg flex items-center text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:border-white-500 hover:shadow-md hover:border">
            <img src="../../img/twitter-black.svg" alt="X" className="w-auto h-7" />
            <p className="ml-3">Follow on Linkedin</p>
            <div className="ml-auto">
              <a href="https://www.linkedin.com/company/lorenzo-protocoo/" target="_blank" rel="noopener noreferrer">
                <button
                  className={`task-button ml-auto bg-blue-500 text-white font-semibold py-2 px-4 rounded 
                    ${
                      repostClicked
                ...
                >
                  {repostClicked ? (repostVerified ? 'Verified' : 'Verifying...') : 'Follow'}
                </button>
              </a>
            </div>
          </div>
        ...
        <div className="w-2/7 flex flex-col justify-center pl-5">
          <img src="https://upload.wikimedia.org/wikipedia/commons/4/46/Bitcoin.svg" alt="coin" className="w-full h-auto rounded-lg mb-4 max-w-xs" />
